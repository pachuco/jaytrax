...
{
    //feel free to add stuff as need arises
    //these functions must be defined to empty dummies at least
    ...
    //functions
    void (*destroy)(struct Resampler *r);
    void (*changeRate)(struct Resampler *r, int rate);
    int32_t (*interpSynt)(struct Resampler *r, Voice *v);
    int32_t (*interpSamp)(struct Resampler *r, Voice *v);
} Resampler;
